...
bar(beam_rx_values, count);
xlabel('Beam Index at Rx');
ylabel('Number of Samples');
title('Distribution of Beam Index at Rx');
...
accuracy = mean(predictions == categorical(in_data.Beam_rx(test(cv))));
fprintf('Classification Accuracy on Test Set: %.2f%%\n', accuracy * 100);
save('dnnModel_rx.mat', 'dnn');