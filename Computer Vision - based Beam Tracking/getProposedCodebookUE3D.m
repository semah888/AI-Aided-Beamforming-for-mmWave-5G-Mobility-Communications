function [beam3D,beamAz,beamEl,beamAngle,beamAngleAz,beamAngleEl] = getProposedCodebookUE3D(numElementV,numElementH,xUE_t,yUE_t,xBS,yBS,r_phi_t,r_theta_t,AODLOS_ref_t,ZODLOS_ref_t)
%azimuth angles 
phi_t = pi-atan((yUE_t-yBS)/(xUE_t-xBS));
%phi_t = pi-AODLOS_ref_t;
