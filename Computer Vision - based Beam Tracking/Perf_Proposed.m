...
dataRate_prop = zeros(numItr,T,7);
for itr = 1:numItr
    iteration = itr
...
for SNR = -30:5:0
    ...
    dataRate_prop(itr,t,i) = computeDataRate_t(t,1,beam_Ex,freqChan,beamBSProp,beamUEProp,1,SNR_linear,numPolAng);
    i = i+1;
end
end
end
...
save("SE_Prop_001.mat","dataRate_Prop_mean");

figure()
load("SE_Prop_001.mat","dataRate_Prop_mean")
%plot(dataRate_Prop_mean03(1,:,end),'color',[0.4660 0.6740 0.1880],'LineWidth',2);hold on;
plot(dataRate_Prop_mean(1,:,end),'r','LineWidth',2);hold on;
load("SE_DFT_Ex_8_8.mat","dr_Ex_mean");
plot(dr_Ex_mean,'color',[0 0.4470 0.7410],'LineWidth',2);hold on;
load("SE_DFT_Lc_8_8.mat","dr_Lc_mean");
plot(dr_Lc_mean,'color',[0.4660 0.6740 0.1880],'LineWidth',2);
xlim([1 101])
